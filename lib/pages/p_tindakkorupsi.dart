...
import 'package:kejaksaan/models/modeltindakkorupsiadd.dart';
import 'dart:typed_data';
import 'package:http/http.dart' as http;


class PengaduanTindakKorupsi extends StatefulWidget {
  const PengaduanTindakKorupsi({super.key});

  @override
  State<PengaduanTindakKorupsi> createState() => _PengaduanTindakKorupsiState();
}

class _PengaduanTindakKorupsiState extends State<PengaduanTindakKorupsi> {
  bool isNamapelaporValid = false;
  bool isNohpValid = false;
  bool isKtplid = false;
  bool isUraianlid = false;
  bool isLaporanValid = false;

  TextEditingController txtNamapelapor = TextEditingController();
  TextEditingController txtUraian = TextEditingController();
  ...
  Future<void> TindakKorupsiAdd() async {
    try {
      setState(() {
        isLoading = true;
      });
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://192.168.0.102/kejaksaan_server/tindakkorupsiPOST.php'),
      );
      request.fields['namapelapor'] = txtNamapelapor.text;
      request.fields['nohp'] = txtNohp.text;
      request.fields['uraian'] = txtUraian.text;
      ...
      ModelTindakKorupsiAdd data = ModelTindakKorupsiAddFromJson(resBody);
      setState(() {
        isLoading = false;
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    "PENGAWASAN TINDAK PIDANA KORUPSI",
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Tulis Uraian Singkat',
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(8),
                            borderSide: BorderSide.none,
                          ),
                          suffixIcon: isUraianlid
                              ? Icon(Icons.check_circle_outline, color: Colors.grey)
                              : null,
                        ),
                      ),
