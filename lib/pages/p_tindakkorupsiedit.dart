...
class TindakKorupsiEdit extends StatefulWidget {
  final String id;
  ...
  @override
  State<TindakKorupsiEdit> createState() => _TindakKorupsiEditState();
}

class _TindakKorupsiEditState extends State<TindakKorupsiEdit> {
  late TextEditingController _txtNamaPelapor;
  late TextEditingController _txtNoHP;
  late TextEditingController _txtUraian;
  ...
  void initState() {
    ...
    _txtUraian = TextEditingController(text: widget.uraian);
    _keyForm = GlobalKey<FormState>();
    _isLoading = false;
  }

  Future<void> _editTindakKorupsi() async {
    ...
    try {
      final url = Uri.parse('http://192.168.0.102/kejaksaan_server/tindakkorupsiUPDATE.php');
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _txtUraian.text.isNotEmpty
                                ? Icon(Icons.check_circle_outline, color: Colors.grey)
                                : null,
                          ),
                          validator: (value) {
