...
class PenyuluhanEdit extends StatefulWidget {
  final String id;
  final String nama;
  final String nohp;
  final String ktp;
  ...
  @override
  State<PenyuluhanEdit> createState() => _PenyuluhanEditState();
}

class _PenyuluhanEditState extends State<PenyuluhanEdit> {
  ...
  Future<void> _editPenyuluhan() async {
    ...
    try {
      final url = Uri.parse('http://192.168.0.102/kejaksaan_server/penyuluhanUPDATE.php');
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _txtNama.text.isNotEmpty
