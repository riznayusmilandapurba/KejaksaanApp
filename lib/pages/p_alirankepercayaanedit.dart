...
import 'package:kejaksaan/models/modelpengawasanadd.dart';
import 'dart:typed_data';
import 'package:http/http.dart' as http;

class PengawasaAliranKepercayaanEdit extends StatefulWidget {
  final String id;
  ...
  const PengawasaAliranKepercayaanEdit({
    required this.id,
  ...
  @override
  State<PengawasaAliranKepercayaanEdit> createState() => _PengawasaAliranKepercayaanEditState();
}

class _PengawasaAliranKepercayaanEditState extends State<PengawasaAliranKepercayaanEdit> {
  ...
  Future<void> _editPengawasan() async {
    ...
    try {
      final url = Uri.parse('http://192.168.0.102/kejaksaan_server/pengawasanUPDATE.php');
      ...
      if (res.statusCode == 200) {
        ModelPengawasanAdd data = ModelPengawasanAddFromJson(resBody);
        setState(() {
          _isLoading = false;
        });
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Center(
                    child: Text(
                      "EDIT PENGAWASAN ALIRAN KEPERCAYAAN",
