...
class Poskopilkada extends StatefulWidget {
  const Poskopilkada({super.key});

  @override
  State<Poskopilkada> createState() => _PoskopilkadaState();
}
...
class _PoskopilkadaState extends State<Poskopilkada> {
  ...
  Future<void> PoskoPilkadaAdd() async {
    try {
      setState(() {
        isLoading = true;
      });
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://192.168.0.102/kejaksaan_server/poskopilkadaPOST.php'),
      );
