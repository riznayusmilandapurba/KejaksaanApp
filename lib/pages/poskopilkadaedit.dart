...
import 'package:kejaksaan/models/modelposkopilkadaadd.dart';
import 'dart:typed_data';
import 'package:http/http.dart' as http;
import 'package:kejaksaan/pages/poskopilkadalist.dart';

class PoskoPilkadaEdit extends StatefulWidget {
  final String id;
  ...
  @override
  State<PoskoPilkadaEdit> createState() => _PoskoPilkadaEditState();
}

class _PoskoPilkadaEditState extends State<PoskoPilkadaEdit> {
  ...
  Future<void> _editPoskoPilkada() async {
    ...
    try {
      final url = Uri.parse('http://192.168.0.102/kejaksaan_server/poskopilkadaUPDATE.php');
      ...
      if (res.statusCode == 200) {
        ModelPoskoPilkadaAdd data = ModelPoskoPilkadaAddFromJson(resBody);
        setState(() {
          _isLoading = false;
        });
